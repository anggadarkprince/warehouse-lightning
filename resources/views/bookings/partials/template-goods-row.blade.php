<tr class="goods-item">
    <td class="px-4 py-1 text-center goods-order">{!! $goodsOrder ?? '' !!}</td>
    <td class="px-4 py-1">
    ...
    <td class="px-4 py-1 goods-unit-name">{!! $unitName ?? '-' !!}</td>
    <td class="px-4 py-1 goods-unit-quantity">{!! $unitQuantityLabel ?? '0' !!}</td>
