<form action="{{ route('tally.save-job', ['work_order' => $workOrder->id]) }}" method="post" id="form-tally-return-empty-container">
    @csrf
    @method('put')
    ...
    <div class="bg-white rounded shadow-sm px-6 py-4 mb-4 text-right">
        <button type="submit" class="button-primary button-sm">Save Job Empty Container</button>
    </div>
</form>
