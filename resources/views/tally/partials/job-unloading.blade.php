<form action="{{ route('tally.save-job', ['work_order' => $workOrder->id]) }}" method="post" id="form-tally-unloading">
    @csrf
    @method('put')
    <div class="bg-white rounded shadow-sm px-6 py-4 mb-4">
        <div class="mb-3 flex justify-between items-center">
            <div>
                ...
                <p class="text-gray-400 leading-tight">List of booking container data</p>
            </div>
        ...
        <table class="table-auto w-full mb-4">
            ...
            <tr>
                ...
                <th class="border-b border-t px-4 py-2 text-right">{{ __('Action') }}</th>
            </tr>
            </thead>
    ...
    <div class="bg-white rounded shadow-sm px-6 py-4 mb-4">
        ...
        <table class="table-auto w-full mb-4">
            ...
            @foreach(old('goods', $goods ?? []) as $index => $item)
                @include('tally.editors.template-goods-row', [
                    'index' => $index,
                    'goodsOrder' => $index + 1,
                    'id' => data_get($item, 'id', ''),
    ...
    <div class="bg-white rounded shadow-sm px-6 py-4 mb-4 text-right">
        <button type="submit" class="button-primary button-sm">Save Job Unloading</button>
    </div>
</form>

@include('tally.editors.modal-form-container', ['containers' => $masterContainers])
