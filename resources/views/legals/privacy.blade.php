...
@section('content')
    <article>
        <h3 class="font-bold text-xl">Privacy Policy of {{ config('app.name', app_setting('app-title')) }}</h3>
        ...
        <p>
            ...
            of Personal Information if anyone decided to use our Service, the Website Name website.
        </p>
        <p>
        ...
        <h5 class="mt-4 mb-2 text-lg font-bold">Information Collection and Use</h5>
        <p>
        ...
        <h5 class="mt-4 mb-2 text-lg font-bold">Log Data</h5>
        <p>
        ...
        <h5 class="mt-4 mb-2 text-lg font-bold">Cookies</h5>
        <p>
        ...
        <p>
            Our website uses these “cookies” to collection information and to improve our Service. You have the option
        ...
        <h5 class="mt-4 mb-2 text-lg font-bold">Service Providers</h5>
        <p>
        ...
        <h5 class="mt-4 mb-2 text-lg font-bold">Security</h5>
        <p>
        ...
        <h5 class="mt-4 mb-2 text-lg font-bold">Links to Other Sites</h5>
        <p>
        ...
        <h5 class="mt-4 mb-2 text-lg font-bold">Changes to This Privacy Policy</h5>
        <p>
