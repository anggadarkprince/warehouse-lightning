    ...
    <body class="antialiased" style="background: #fdfdfd">
            ...
            <header class="relative py-4">
                <div class="absolute mx-auto bg-white" style="left: 50%; transform: translateX(-50%)">
                    <ul class="flex flex-col md:flex-row content-center">
                        <li class="py-2 border-b-2 border-green-500"><a href="#" class="px-3 font-bold text-green-500">Home</a></li>
                        <li class="py-2"><a href="#" class="px-3 hover:text-green-500">Solution</a></li>
                        <li class="py-2"><a href="#" class="px-3 hover:text-green-500">Use Case</a></li>
                        <li class="py-2"><a href="#" class="px-3 hover:text-green-500">Features</a></li>
                        <li class="py-2"><a href="#" class="px-3 hover:text-green-500">Contact</a></li>
                    </ul>
                </div>
        ...
        <footer>
            ...
            <div class="border-t border-gray-200">
                <div class="text-gray-600 px-4 py-6 max-w-6xl mx-auto flex justify-between">
                    <p>
