        ...
        <form action="{{ url()->current() }}" method="get" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="w-full">
                        <select class="form-input select-choice" name="container_size" id="container_size" data-search-enable="false">
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="w-full">
                        <select class="form-input select-choice" name="is_empty" id="is_empty">
            ...
            <div class="flex flex-wrap">
                ...
                <div class="relative w-full">
                    ...
                    <span class="close clear-date-button clear-date-stock">&times;</span>
                </div>
            </div>
            <div class="flex flex-wrap">
