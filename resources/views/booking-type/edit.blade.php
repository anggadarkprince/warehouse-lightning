            ...
            <div class="py-2">
                        ...
                        <div class="flex flex-wrap mb-3 sm:mb-4">
                            ...
                            <div class="relative w-full">
                                <select class="form-input pr-8" name="type" id="type">
                                    <option value="INBOUND"{{ old('type', $bookingType->type) == 'INBOUND' ? 'selected' : '' }}>
                                        INBOUND
                                    </option>
                                    <option value="OUTBOUND"{{ old('type', $bookingType->type) == 'OUTBOUND' ? 'selected' : '' }}>
                                        OUTBOUND
                                    </option>
                                </select>
                ...
                <div class="flex flex-wrap">
                    ...
                    <textarea id="description" type="text" class="form-input @error('description') border-red-500 @enderror"
                              placeholder="Document type description" name="description">{{ old('description', $bookingType->description) }}</textarea>
